    ...
    <div className="mx-auto max-w-[1600px] px-5 pb-28 pt-36 sm:px-8">
      ...
      <div className="mt-16">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {countries.map((country, i) => (
            <Reveal key={country.slug} delay={i * 0.08}>
              <Link
                ...
                className="group flex flex-col border border-white/10 transition-colors duration-500 hover:border-accent/60"
              >
          ...
          <Reveal delay={0.1}>
            <div className="flex aspect-auto min-h-[280px] flex-col items-center justify-center gap-3 border border-dashed border-white/10 lg:aspect-[16/9]">
